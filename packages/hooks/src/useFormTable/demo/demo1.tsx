 ...
 * desc: useFormTable returns a search object after receiving a form instance. This is an example of antd v3, see [link](https://github.com/wetrial/hooks/blob/master/packages/hooks/src/useFormTable/demo/demo3.tsx) for an example of antd v4.
 *
 * title.zh-CN: Form 与 Table 联动
 * desc.zh-CN: useFormTable 接收 form 实例后，会返回 search 对象。这是一个 antd v3 示例，antd v4 示例见 [链接](https://github.com/wetrial/hooks/blob/master/packages/hooks/src/useFormTable/demo/demo3.tsx)。
 */
...
import { PaginatedParams } from '@wetrial/hooks/useFormTable/lib'
